                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 480px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
                    <tr>
                        <td style="padding: 40px 32px;">
                            <h1 style="margin: 0 0 8px; font-size: 24px; font-weight: 600; color: #18181b;">Verify account deletion</h1>
                            <p style="margin: 0 0 24px; font-size: 15px; color: #71717a; line-height: 1.5;">Use the code below to confirm your {{ $appName }} account deletion request.</p>
                            ...
                            <p style="margin: 0; font-size: 13px; color: #a1a1aa;">This code expires in 10 minutes. Do not share it with anyone.</p>
                        </td>
                    </tr>
                </table>
            </td>
