...
use App\Filament\Admin\Resources\GroupFieldResource\Pages;
...
class GroupFieldResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Groups Fields';

    protected static ?string $modelLabel = 'Group Field';

    protected static ?string $pluralModelLabel = 'Groups Fields';
    ...
    {
        return [
            'index' => Pages\ListGroupFields::route('/'),
            'create' => Pages\CreateGroupField::route('/create'),
            'edit' => Pages\EditGroupField::route('/{record}/edit'),
        ];
    }
}
