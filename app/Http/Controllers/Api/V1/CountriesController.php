...
class CountriesController extends BaseController
{
    ...
    /**
     * Get countries meta (for explore page filters)
     * Returns countries as key-value pairs for easy lookup
     * Ordered by ID (0, 1, 2, etc.) not alphabetically
     */
    public function meta(Request $request): JsonResponse
    {
        ...
        // Keep original array structure for countries_name (key-value pairs)
        $countriesName = [];
        foreach ($countriesArray as $id => $name) {
            if ($id !== '0') { // Skip "Select Country"
                $countriesName[$id] = $name;
            }
        }
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'countries_name' => $countriesName, // Key-value pairs for backward compatibility
            ],
        ]);
    }
}
